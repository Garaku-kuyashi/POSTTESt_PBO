...
//        listOperator.add(operator);
        ...
        if (tipe == 1){
            ...
            System.out.print("Tipe Defender (Protector/Guardian): ");
    ...
    static void update() {
        ...
        lihat();
        System.out.println("Masukkan Nomor Yang Ingin Di Update: ");
        ...
        if (index >= 0 && index < listOperator.size()){
            ...
            if (operator instanceof Vanguard){
                ...
                Defender defender = (Defender) operator;
                ...
                if (pilih == 1) {
                    System.out.print("Masukkan nilai DEF tambahan: ");
                    defender.tambahPertahanan(input.nextInt());
                } else if (pilih == 2) {
                    System.out.print("Masukkan persentase buff (contoh 0.2 untuk 20%): ");
                    defender.tambahPertahanan(input.nextDouble());
                } else{
